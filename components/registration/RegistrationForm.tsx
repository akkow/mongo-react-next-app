...
export function RegistrationForm(props: IProps) {
    ...
    const onSubmit = async (data: FieldValues) => {
        ...
        registrationData.isEmployer = false;
    ...
    return (
        <>
        <Toaster />
        <div className="relative flex flex-col items-center bg-transparent bg-clip-border text-gray-700 py-10">
        ...
        <div className="relative flex flex-col items-center bg-transparent bg-clip-border text-gray-700">
            <Link className="flex mx-3 p-6 shadow-sm rounded-xl border-2 border-blue-500 hover:bg-green-500 hover:text-white font-bold transition-all hover:shadow-xl" href={'/employerRegistration'}>Darbdavio Registracija</Link>
        </div>  
        </>   
    )
}