    ...
    <header className="bg-white">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-2 lg:px-8" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative flex items-center gap-x-2">
            <Popover.Button className="transition-colors hover:text-green-500 flex items-center gap-x-1 text-md font-bold leading-6 text-black">
              Ieškoti pagal sritį
