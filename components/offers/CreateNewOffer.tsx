...
export function CreateNewOffer(props: IProps) {
    ...
    return (
        <>
            <Toaster />
            <div id='form-edit' className="flex flex-col items-center inset- bg-transparent bg-clip-border text-gray-700 bottom-40">
                <div className="flex mx-3 px-10 py-4 shadow-xl rounded-xl">
                    <form onSubmit={handleSubmit(onSubmit)} className="mb-2 w-96 max-w-screen-lg" noValidate>
