...
export function OffersListForFinance(props: IProps) {

    const { offers } = props
    const financeoffers = []
    
    for(let i = 0; i < offers.length; i++) {
        if(offers[i].category === 'Finansai'){
            financeoffers.push(offers[i]);
        }
    }
    ...
    <>
        <div className="flex flex-col items-center mt-2 mb-10">
            <h1 className="font-bold text-2xl text-black mt-2 mb-4">Finansų srities skelbimai</h1>
