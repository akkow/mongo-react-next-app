...
export function OfferList(props: IProps) {
    ...
    return (
    <>
        <div id='offers-list' className="hidden">
            <div className="flex flex-col items-center">
                <div className="flex items-center gap-3">
                    <label className="mt-7 input flex items-center gap-2 bg-gray-100">
                    ...
                    <button onClick={() => setParams()} className="mt-7 transition-colors shadow bg-black hover:shadow-xl hover:bg-green-500 hover:rounded-lg py-2 px-6 focus:shadow-outline focus:outline-none font-bold text-md rounded leading-6 text-white" type='submit' id="search-btn">
                    ...
                    <button id="clearFiltersBtn" onClick={() => clearFilters()} className="mt-7 transition-colors shadow bg-black hover:shadow-xl hover:bg-green-500 hover:rounded-lg py-2 px-6 focus:shadow-outline focus:outline-none font-bold text-md rounded leading-6 text-white" type='submit'>
                        <div className="flex items-center gap-x-2">
            ...
            {displayList < filterOffersByParams.length ? <button onClick={() => loadMore()} className="mt-7 transition-colors shadow bg-black hover:shadow-xl hover:bg-green-500 hover:rounded-lg py-2 px-6 focus:shadow-outline focus:outline-none font-bold text-md rounded leading-6 text-white" type='submit' id="save-btn">
                <div className="flex items-center gap-x-2">
                    Rodyti daugiau
                </div>
            </button> : ''}
