    ...
    <>
        <div className="flex flex-col items-center">
            <div className="flex items-center gap-3">
                ...
                <FilterComboBox getDataFromChildren={handleDataFromChildrenCities} />
                <FilterComboBoxCategory getDataFromChildren={handleDataFromChildrenCategories} />
                ...
                <button onClick={() => clearFilters()} className="mt-7 transition-colors shadow bg-black hover:shadow-xl hover:bg-green-500 hover:rounded-lg py-2 px-6 focus:shadow-outline focus:outline-none font-bold text-md rounded font-semibold leading-6 text-white" type='submit' id="save-btn">
                    <div className="flex items-center gap-x-2">
