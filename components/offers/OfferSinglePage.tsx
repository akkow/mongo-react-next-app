                ...
                <div className="relative flex flex-col items-center rounded-lg shadow-xl border w-[80%] mt-10 mx-auto">
                    <div className="w-[90%] py-4">
                        ...
                        <div className="flex justify-between">
                            ...
                            {offerData.created_by == session.user._id && <button data-tip="Redaguoti" onClick={()=> (document.getElementById('my_modal_5') as HTMLDialogElement).showModal()} className="tooltip tooltip-right text-black hover:text-green-500" type="button">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
